from TrueConsense.Coverage import GetCoverage
import os
import sys
...
def WriteOutputs(cov, iDict, uGffDict, inputbam, IncludeAmbig, WriteVCF, name, ref, outdir):
    """
            ...
            for i in range(len(reflist)):
                ...
                if reflist[i] != seqlist[i]:
                    ...
                    if seqlist[i] == "-":
                        ...
                        out.write(f"{refID}\t{i}\t.\t{joinedreflist}\t{seqlist[i-1]}\t.\tPASS\tDP={currentcov};INDEL\n")
                    else:
                        if i == 0:
                            p = 1
                        elif i ==1:
                        ...
                        out.write(f"{refID}\t{i+1}\t.\t{reflist[i]}\t{seqlist[i]}\t.\tPASS\tDP={currentcov}\n")
                        ...
                        if i == lposition:
                            ...
                            try:
                                ...
                                if to_insert is not None:
                                    ...
                                    out.write(f"{refID}\t{i}\t.\t{reflist[i]}\t{CombinedEntry}\t.\tPASS\tDP={currentcov};INDEL\n")
                                else:
                                    continue
                            except:
                                continue
